...
def main():
    ...
    for i in range(len(strips_input)):
        ...
        orthorectify_pan_command = f'gdalwarp -q -co "COMPRESS=LZW" -co "BIGTIFF=IF_SAFER" -co "TILED=YES" -s_srs EPSG:{strip_epsg} -t_srs EPSG:{strip_epsg} -r cubic -et 0.01 -rpc -to "RPC_DEM={strip}" {pan_file} {pan_orthorectified_file}'
